...
bench: build
    ...
    hyperfine --warmup 3 '{{ bin }} new --no-tui -r 3457/357/5 20 16 7 -x 3 -s D2- -n a'
...
bench-compare: build
    ...
    hyperfine --warmup 3 '{{ bin }} new --no-tui -r 3457/357/5 20 16 7 -x 3 -s D2- -n a' 'rlifesrc 20 16 7 3 0 -s D2- -r 3457/357/5 --no-tui'
